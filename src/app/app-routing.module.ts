...
import { EditusComponent } from './components/editus/editus.component';
...
import { Grafico4Component } from './components/grafico4/grafico4.component';
...
const routes: Routes = [
  ...
  { path: 'edus/:usuario', component: EditusComponent},
